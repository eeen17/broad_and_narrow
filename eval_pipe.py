...
def main():
    ...
    if args.n_digits == 2:
        q_main(f'arithmetic/data/0shot/base{args.base}.txt', args.base, args.model_name, f'output.txt', cot=args.cot, n_shots=args.n_shots, size=args.size)
    elif args.n_digits == 3:
        q_main(f'arithmetic/data/0shot_3digits/base{args.base}.txt', args.base, args.model_name, f'output.txt', cot=args.cot, n_shots=args.n_shots, size=args.size)
    elif args.n_digits == 4:
        q_main(f'arithmetic/data/0shot_4digits/base{args.base}.txt', args.base, args.model_name, f'output.txt', cot=args.cot, n_shots=args.n_shots, size=args.size)
